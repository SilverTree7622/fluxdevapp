function CInterface(iFrictionPrice,iMaxSpeedPrice){
    ...
    this._init = function(iFrictionPrice,iMaxSpeedPrice){      
        ...
        _oButFriction = new CButUpgrade(_pStartPosFriction.x,_pStartPosFriction.y,iFrictionPrice,
                                (s_iUpgradeFriction===PRICE_FRICTION.length-1)?s_iUpgradeFriction:s_iUpgradeFriction+1,oSpriteBut,s_oStage);
        ...
        _oButMaxSpeed = new CButUpgrade(_pStartPosFriction.x,_pStartPosFriction.y,iMaxSpeedPrice,
                                                (s_iUpgradeMaxSpeed===PRICE_MAX_SPEED.length-1)?s_iUpgradeMaxSpeed:s_iUpgradeMaxSpeed+1,oSpriteBut,s_oStage);
