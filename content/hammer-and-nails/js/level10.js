...
var level10 = new Phaser.Class({
    ...
    create: function () {
        ...
        level10background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level10wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level10blast = this.add.sprite(150, 209, 'level1blast').setOrigin(0, 0)

        level10blast.visible = false
        ...
        for (var i = 20; i >= 1; i--) {
            ...
            game['level10nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level10nail' + i].setFrame(1);
            game['level10nail' + i].visible = false


        }

        game['level10nail' + 1].visible = true
        ...
        levelpop1.add(level10wood)

        for (i = 20; i >= 1; i--) {
            levelpop1.add(game['level10nail' + i])
        }

        levelpop1.add(level10blast)
        ...
        level10blast.anims.load('level1blast')
        level10blast.x = 354
        level10blast.y = 422
        ...
        function timecheck() {
            ...
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 20 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 20 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        level10lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level10lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level10lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level10lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level10lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level10lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level10lpmask1.createBitmapMask();
        mask.alpha = 0
        
        level10lpbar4.setMask(mask);
        level10lpbar3.setMask(mask);
        level10lpbar2.setMask(mask);
        level10lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)

        level10stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)




        for (i = 20; i >= 1; i--) {
            game['level10nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            if (game['level10nail' + narr1[0]].x >= 75 && game['level10nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level10nail' + narr1[0]].x - 65
                lhammer.y = game['level10nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level10nail' + narr1[0]].x >= 215 && game['level10nail' + narr1[0]].x <= 354) {
                shammer.x = game['level10nail' + narr1[0]].x - 45
                shammer.y = game['level10nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level10nail' + narr1[0]].x >= 355 && game['level10nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level10nail' + narr1[0]].x - 45
                rhammer.y = game['level10nail' + narr1[0]].y - 45
            ...
            if (game['level10nail' + narr1[0]].frame.name == 1) {
                game['level10nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level10nail' + narr1[0]].frame.name == 2) {
                game['level10nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level10nail' + narr1[0]].frame.name == 3) {
                game['level10nail' + narr1[0]].setFrame(harr1[3])
                game['level10nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level10nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 500,
                    duration: 300,
                ...
                if (narr1[0] <= 20) {
                    ...
                    if (nailcount < 20) {
                        game['level10nail' + (nailcount + 1)].visible = true
                    }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level10lpbar1.x = level10lpbar1.x + (282 / 20)
            level10lpbar2.x = level10lpbar2.x + (282 / 20)
            level10lpbar3.x = level10lpbar3.x + (282 / 20)
            level10lpbar4.x = level10lpbar4.x + (282 / 20)
            if (nailcount == 20) {
                nextnail = false
            }
       ...
       failedpanel = this.add.image(240, 427, 'failedpanel').setOrigin(0.5, 0.5)
        ...
        level10home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level10home.setScale(0.85)
        level10home.on('pointerdown', homeFun)
        level10home.on('pointerover', homeoverFun)
        level10home.on('pointerout', homeoutFun)
    ...
    update: function () {
        ...
        if ((Math.round(level10lpbar1.x) <= 134)) {
            if (Math.round(level10lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level10lpbar1.setVisible(true);
                level10lpbar2.setVisible(false);
                level10lpbar3.setVisible(false);
                level10lpbar4.setVisible(false);
                emojis.x = Math.round(level10lpbar1.x) + 252
            } else if ((Math.round(level10lpbar1.x) > -77.5) && (Math.round(level10lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level10lpbar1.setVisible(false);
                level10lpbar2.setVisible(true);
                level10lpbar3.setVisible(false);
                level10lpbar4.setVisible(false);
                emojis.x = Math.round(level10lpbar1.x) + 252
            } else if ((Math.round(level10lpbar1.x) > -7) && (Math.round(level10lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level10lpbar1.setVisible(false);
                level10lpbar2.setVisible(false);
                level10lpbar3.setVisible(true);
                level10lpbar4.setVisible(false);
                emojis.x = Math.round(level10lpbar1.x) + 252
            } else if ((Math.round(level10lpbar1.x) > 63.5) && (Math.round(level10lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level10lpbar1.setVisible(false);
                level10lpbar2.setVisible(false);
                level10lpbar3.setVisible(false);
                level10lpbar4.setVisible(true);
                emojis.x = Math.round(level10lpbar1.x) + 252
            }
        } else if ((Math.round(level10lpbar1.x) > 134)) {
            level10lpbar1.x = 134
            level10lpbar2.x = 134
            level10lpbar3.x = 134
            level10lpbar4.x = 134
