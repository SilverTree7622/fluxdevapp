...
var randomArrx = [0];
var randomArry = [0];
var level18 = new Phaser.Class({
    Extends: Phaser.Scene,
    initialize: function level18() {
    ...
    create: function () {
        ...
        level18background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level18wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level18blast = this.add.sprite(150, 209, 'level1blast').setOrigin(0, 0)

        level18blast.visible = false
        ...
        for (var i = 35; i >= 1; i--) {
            ...
            game['level18nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level18nail' + i].setFrame(1);
            game['level18nail' + i].visible = false

        }
        game['level18nail' + 1].visible = true
        ...
        levelpop1.add(level18wood)
        levelpop1.add(bomb)
        levelpop1.add(explode)
        for (i = 35; i >= 1; i--) {
            levelpop1.add(game['level18nail' + i])
        }

        levelpop1.add(level18blast)
        ...
        level18blast.anims.load('level1blast')
        level18blast.x = 254
        level18blast.y = 422
        ...
        function timecheck() {
            ...
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 35 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 35 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        level18lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level18lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level18lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level18lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level18lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level18lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level18lpmask1.createBitmapMask();
        mask.alpha = 0
        
        level18lpbar4.setMask(mask);
        level18lpbar3.setMask(mask);
        level18lpbar2.setMask(mask);
        level18lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)

        level18stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)




        for (i = 35; i >= 1; i--) {
            game['level18nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            if (game['level18nail' + narr1[0]].x >= 75 && game['level18nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level18nail' + narr1[0]].x - 65
                lhammer.y = game['level18nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level18nail' + narr1[0]].x >= 215 && game['level18nail' + narr1[0]].x <= 354) {
                shammer.x = game['level18nail' + narr1[0]].x - 45
                shammer.y = game['level18nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level18nail' + narr1[0]].x >= 355 && game['level18nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level18nail' + narr1[0]].x - 45
                rhammer.y = game['level18nail' + narr1[0]].y - 45
            ...
            if (game['level18nail' + narr1[0]].frame.name == 1) {
                game['level18nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level18nail' + narr1[0]].frame.name == 2) {
                game['level18nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level18nail' + narr1[0]].frame.name == 3) {
                game['level18nail' + narr1[0]].setFrame(harr1[3])
                game['level18nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level18nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 300,
                    duration: 300,
                ...
                if (narr1[0] <= 35) {
                    ...
                    if (nailcount < 35) {
                        game['level18nail' + (nailcount + 1)].visible = true
                    }
                }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level18lpbar1.x = level18lpbar1.x + (282 / 35)
            level18lpbar2.x = level18lpbar2.x + (282 / 35)
            level18lpbar3.x = level18lpbar3.x + (282 / 35)
            level18lpbar4.x = level18lpbar4.x + (282 / 35)
            if (nailcount == 35) {
                nextnail = false
        ...
        function bombFun() {
            ...
            level18blast.visible = true
            bomb.visible = false
            level18blast.x = bomb.x - 30
            level18blast.y = bomb.y - 10
            level18blast.anims.play('level1blast')
            for (i = 35; i >= 1; i--) {
                game['level18nail' + i].disableInteractive()
            }
        ...
        bomb.alpha = 0
        if (nailcount < 35 && nextnail && timearr[1] != 0) {
        ...
        level18home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level18home.setScale(0.85)
        level18home.on('pointerdown', homeFun)
        level18home.on('pointerover', homeoverFun)
        level18home.on('pointerout', homeoutFun)
    ...
    update: function () {
        ...
        if ((Math.round(level18lpbar1.x) <= 134)) {
            if (Math.round(level18lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level18lpbar1.setVisible(true);
                level18lpbar2.setVisible(false);
                level18lpbar3.setVisible(false);
                level18lpbar4.setVisible(false);
                emojis.x = Math.round(level18lpbar1.x) + 252
            } else if ((Math.round(level18lpbar1.x) > -77.5) && (Math.round(level18lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level18lpbar1.setVisible(false);
                level18lpbar2.setVisible(true);
                level18lpbar3.setVisible(false);
                level18lpbar4.setVisible(false);
                emojis.x = Math.round(level18lpbar1.x) + 252
            } else if ((Math.round(level18lpbar1.x) > -7) && (Math.round(level18lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level18lpbar1.setVisible(false);
                level18lpbar2.setVisible(false);
                level18lpbar3.setVisible(true);
                level18lpbar4.setVisible(false);
                emojis.x = Math.round(level18lpbar1.x) + 252
            } else if ((Math.round(level18lpbar1.x) > 63.5) && (Math.round(level18lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level18lpbar1.setVisible(false);
                level18lpbar2.setVisible(false);
                level18lpbar3.setVisible(false);
                level18lpbar4.setVisible(true);
                emojis.x = Math.round(level18lpbar1.x) + 252
            }
        } else if ((Math.round(level18lpbar1.x) > 134)) {
            level18lpbar1.x = 134
            level18lpbar2.x = 134
            level18lpbar3.x = 134
            level18lpbar4.x = 134
