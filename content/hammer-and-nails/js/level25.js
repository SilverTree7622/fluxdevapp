...
var level25 = new Phaser.Class({
    ...
    create: function () {
        ...
        level25background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level25wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level25blast = this.add.sprite(150, 209, 'level1blast').setOrigin(0, 0)

        level25blast.visible = false
        ...
        for (var i = 45; i >= 1; i--) {
            ...
            game['level25nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level25nail' + i].setFrame(1);
            game['level25nail' + i].visible = false

        }
        game['level25nail' + 1].visible = true
        ...
        levelpop1.add(level25wood)
        levelpop1.add(bomb)
        levelpop1.add(explode)
        for (i = 45; i >= 1; i--) {
            levelpop1.add(game['level25nail' + i])
        }

        levelpop1.add(level25blast)
        ...
        level25blast.anims.load('level1blast')
        level25blast.x = 354
        level25blast.y = 422
        anim = game.scene.scenes[pageNo].anims.create({
            key: 'bomb',
        ...
        function timecheck() {
            ...
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 45 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 45 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        level25lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level25lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level25lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level25lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level25lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level25lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level25lpmask1.createBitmapMask();
        mask.alpha = 0
        
        level25lpbar4.setMask(mask);
        level25lpbar3.setMask(mask);
        level25lpbar2.setMask(mask);
        level25lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)

        level25stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)




        for (i = 45; i >= 1; i--) {
            game['level25nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            if (game['level25nail' + narr1[0]].x >= 75 && game['level25nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level25nail' + narr1[0]].x - 65
                lhammer.y = game['level25nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level25nail' + narr1[0]].x >= 215 && game['level25nail' + narr1[0]].x <= 354) {
                shammer.x = game['level25nail' + narr1[0]].x - 45
                shammer.y = game['level25nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level25nail' + narr1[0]].x >= 355 && game['level25nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level25nail' + narr1[0]].x - 45
                rhammer.y = game['level25nail' + narr1[0]].y - 45
            ...
            if (game['level25nail' + narr1[0]].frame.name == 1) {
                game['level25nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level25nail' + narr1[0]].frame.name == 2) {
                game['level25nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level25nail' + narr1[0]].frame.name == 3) {
                game['level25nail' + narr1[0]].setFrame(harr1[3])
                game['level25nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level25nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 300,
                    duration: 300,
                ...
                if (narr1[0] <= 45) {
                    ...
                    if (nailcount < 45) {
                        game['level25nail' + (nailcount + 1)].visible = true
                    }
                }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level25lpbar1.x = level25lpbar1.x + (282 / 45)
            level25lpbar2.x = level25lpbar2.x + (282 / 45)
            level25lpbar3.x = level25lpbar3.x + (282 / 45)
            level25lpbar4.x = level25lpbar4.x + (282 / 45)
            if (nailcount == 45) {
                nextnail = false
        ...
        function bombFun() {
            ...
            level25blast.visible = true
            bomb.visible = false
            level25blast.x = bomb.x
            level25blast.y = bomb.y
            level25blast.anims.play('level1blast')

            for (i = 45; i >= 1; i--) {
                game['level25nail' + i].disableInteractive()
            }
        ...
        bomb.alpha = 0
        if (nailcount < 45 && nextnail && timearr[1] != 0) {
       ...
       level25home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level25home.setScale(0.85)
        level25home.on('pointerdown', homeFun)
        level25home.on('pointerover', homeoverFun)
        level25home.on('pointerout', homeoutFun)
    ...
    update: function () {
        ...
        if ((Math.round(level25lpbar1.x) <= 134)) {
            if (Math.round(level25lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level25lpbar1.setVisible(true);
                level25lpbar2.setVisible(false);
                level25lpbar3.setVisible(false);
                level25lpbar4.setVisible(false);
                emojis.x = Math.round(level25lpbar1.x) + 252
            } else if ((Math.round(level25lpbar1.x) > -77.5) && (Math.round(level25lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level25lpbar1.setVisible(false);
                level25lpbar2.setVisible(true);
                level25lpbar3.setVisible(false);
                level25lpbar4.setVisible(false);
                emojis.x = Math.round(level25lpbar1.x) + 252
            } else if ((Math.round(level25lpbar1.x) > -7) && (Math.round(level25lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level25lpbar1.setVisible(false);
                level25lpbar2.setVisible(false);
                level25lpbar3.setVisible(true);
                level25lpbar4.setVisible(false);
                emojis.x = Math.round(level25lpbar1.x) + 252
            } else if ((Math.round(level25lpbar1.x) > 63.5) && (Math.round(level25lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level25lpbar1.setVisible(false);
                level25lpbar2.setVisible(false);
                level25lpbar3.setVisible(false);
                level25lpbar4.setVisible(true);
                emojis.x = Math.round(level25lpbar1.x) + 252
            }
        } else if ((Math.round(level25lpbar1.x) > 134)) {
            level25lpbar1.x = 134
            level25lpbar2.x = 134
            level25lpbar3.x = 134
            level25lpbar4.x = 134
