...
var randomArrx = [0];
var randomArry = [0];
var level20 = new Phaser.Class({
    Extends: Phaser.Scene,
    initialize: function level20() {
    ...
    create: function () {
        ...
        level20background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level20wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level20blast = this.add.sprite(150, 209, 'level1blast').setOrigin(0, 0)

        level20blast.visible = false
        ...
        for (var i = 39; i >= 1; i--) {
            ...
            game['level20nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level20nail' + i].setFrame(1);
            game['level20nail' + i].visible = false

        }
        game['level20nail' + 1].visible = true
        ...
        levelpop1.add(level20wood)
        levelpop1.add(bomb)
        levelpop1.add(explode)
        for (i = 39; i >= 1; i--) {
            levelpop1.add(game['level20nail' + i])
        }

        levelpop1.add(level20blast)
        ...
        level20blast.anims.load('level1blast')
        level20blast.x = 354
        level20blast.y = 422
        ...
        function timecheck() {
            ...
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 39 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 39 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        level20lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level20lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level20lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level20lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level20lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level20lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level20lpmask1.createBitmapMask();
        mask.alpha = 0
        
        level20lpbar4.setMask(mask);
        level20lpbar3.setMask(mask);
        level20lpbar2.setMask(mask);
        level20lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)

        level20stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)




        for (i = 39; i >= 1; i--) {
            game['level20nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            if (game['level20nail' + narr1[0]].x >= 75 && game['level20nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level20nail' + narr1[0]].x - 65
                lhammer.y = game['level20nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level20nail' + narr1[0]].x >= 215 && game['level20nail' + narr1[0]].x <= 354) {
                shammer.x = game['level20nail' + narr1[0]].x - 45
                shammer.y = game['level20nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level20nail' + narr1[0]].x >= 355 && game['level20nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level20nail' + narr1[0]].x - 45
                rhammer.y = game['level20nail' + narr1[0]].y - 45
            ...
            if (game['level20nail' + narr1[0]].frame.name == 1) {
                game['level20nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level20nail' + narr1[0]].frame.name == 2) {
                game['level20nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level20nail' + narr1[0]].frame.name == 3) {
                game['level20nail' + narr1[0]].setFrame(harr1[3])
                game['level20nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level20nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 300,
                    duration: 300,
                ...
                if (narr1[0] <= 39) {
                    ...
                    if (nailcount < 39) {
                        game['level20nail' + (nailcount + 1)].visible = true
                    }
                }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level20lpbar1.x = level20lpbar1.x + (282 / 39)
            level20lpbar2.x = level20lpbar2.x + (282 / 39)
            level20lpbar3.x = level20lpbar3.x + (282 / 39)
            level20lpbar4.x = level20lpbar4.x + (282 / 39)
            if (nailcount == 39) {
                nextnail = false
        ...
        function bombFun() {
            ...
            level20blast.visible = true
            bomb.visible = false
            level20blast.x = bomb.x
            level20blast.y = bomb.y
            level20blast.anims.play('level1blast')

            for (i = 39; i >= 1; i--) {
                game['level20nail' + i].disableInteractive()
            }
        ...
        bomb.alpha = 0
        if (nailcount < 39 && nextnail && timearr[1] != 0) {
        ...
        level20home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level20home.setScale(0.85)
        level20home.on('pointerdown', homeFun)
        level20home.on('pointerover', homeoverFun)
        level20home.on('pointerout', homeoutFun)
    ...
    update: function () {
        ...
        if ((Math.round(level20lpbar1.x) <= 134)) {
            if (Math.round(level20lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level20lpbar1.setVisible(true);
                level20lpbar2.setVisible(false);
                level20lpbar3.setVisible(false);
                level20lpbar4.setVisible(false);
                emojis.x = Math.round(level20lpbar1.x) + 252
            } else if ((Math.round(level20lpbar1.x) > -77.5) && (Math.round(level20lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level20lpbar1.setVisible(false);
                level20lpbar2.setVisible(true);
                level20lpbar3.setVisible(false);
                level20lpbar4.setVisible(false);
                emojis.x = Math.round(level20lpbar1.x) + 252
            } else if ((Math.round(level20lpbar1.x) > -7) && (Math.round(level20lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level20lpbar1.setVisible(false);
                level20lpbar2.setVisible(false);
                level20lpbar3.setVisible(true);
                level20lpbar4.setVisible(false);
                emojis.x = Math.round(level20lpbar1.x) + 252
            } else if ((Math.round(level20lpbar1.x) > 63.5) && (Math.round(level20lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level20lpbar1.setVisible(false);
                level20lpbar2.setVisible(false);
                level20lpbar3.setVisible(false);
                level20lpbar4.setVisible(true);
                emojis.x = Math.round(level20lpbar1.x) + 252
            }
        } else if ((Math.round(level20lpbar1.x) > 134)) {
            level20lpbar1.x = 134
            level20lpbar2.x = 134
            level20lpbar3.x = 134
            level20lpbar4.x = 134
