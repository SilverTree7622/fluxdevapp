var startgame20 = false
var clickstart = 0
var timevalue = 1
var timearr = [0, 60, 0, 0, 0, 0, 0, 0]
...
var randomArrx = [0];
var randomArry = [0];
var level17 = new Phaser.Class({
    Extends: Phaser.Scene,
    initialize: function level17() {
    ...
    preload: function () {
        ...
        randomArrx = [0]
        randomArry = [0]
        timearr = [0, 60, 0, 0, 0, 0, 0, 0]
        timevalue = 1
        time = timevalue * 60
    },
    create: function () {

        level17background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level17wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level17blast = this.add.sprite(150, 209, 'level1blast').setOrigin(0, 0)

        level17blast.visible = false
        bomb = this.add.sprite(300, 200, 'bomb').setOrigin(0, 0).setInteractive();
        explode = this.add.sprite(300, 200, 'explode').setOrigin(0, 0).setInteractive();
        ...
        for (var i = 33; i >= 1; i--) {
            ...
            game['level17nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level17nail' + i].setFrame(1);
            game['level17nail' + i].visible = false

        }
        game['level17nail' + 1].visible = true
        ...
        levelpop1.add(level17wood)
        levelpop1.add(explode)
        levelpop1.add(level17blast)
        levelpop1.add(bomb)

        for (i = 33; i >= 1; i--) {
            levelpop1.add(game['level17nail' + i])
        }
        ...
        level17blast.anims.load('level1blast')
        level17blast.x = 354
        level17blast.y = 422
        ...
        function timecheck() {
            ...
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 33 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 33 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        level17lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level17lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level17lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level17lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level17lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level17lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level17lpmask1.createBitmapMask();
        mask.alpha = 0
        
        level17lpbar4.setMask(mask);
        level17lpbar3.setMask(mask);
        level17lpbar2.setMask(mask);
        level17lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)

        level17stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)




        for (i = 33; i >= 1; i--) {
            game['level17nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            if (game['level17nail' + narr1[0]].x >= 75 && game['level17nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level17nail' + narr1[0]].x - 65
                lhammer.y = game['level17nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level17nail' + narr1[0]].x >= 215 && game['level17nail' + narr1[0]].x <= 354) {
                shammer.x = game['level17nail' + narr1[0]].x - 45
                shammer.y = game['level17nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level17nail' + narr1[0]].x >= 355 && game['level17nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level17nail' + narr1[0]].x - 45
                rhammer.y = game['level17nail' + narr1[0]].y - 45
            ...
            if (game['level17nail' + narr1[0]].frame.name == 1) {
                game['level17nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level17nail' + narr1[0]].frame.name == 2) {
                game['level17nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level17nail' + narr1[0]].frame.name == 3) {
                game['level17nail' + narr1[0]].setFrame(harr1[3])
                game['level17nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level17nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 3 && timearr[1] != 000,
                    duration: 300,
                });
                if (narr1[0] <= 33) {
                    ...
                    if (nailcount < 33) {
                        game['level17nail' + (nailcount + 1)].visible = true
                    }
                }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level17lpbar1.x = level17lpbar1.x + (282 / 33)
            level17lpbar2.x = level17lpbar2.x + (282 / 33)
            level17lpbar3.x = level17lpbar3.x + (282 / 33)
            level17lpbar4.x = level17lpbar4.x + (282 / 33)
            if (nailcount == 33) {
                nextnail = false
        ...
        function bombFun() {
            ...
            level17blast.visible = true
            bomb.visible = false
            level17blast.x = bomb.x - 30
            level17blast.y = bomb.y - 10
            level17blast.anims.play('level1blast')

            for (i = 33; i >= 1; i--) {
                game['level17nail' + i].disableInteractive()
            }
        ...
        bomb.alpha = 0
        if (nailcount < 33 && nextnail && timearr[1] != 0) {
       ...
       failedpanel = this.add.image(240, 427, 'failedpanel').setOrigin(0.5, 0.5)
        ...
        level17home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level17home.setScale(0.85)
        level17home.on('pointerdown', homeFun)
        level17home.on('pointerover', homeoverFun)
        level17home.on('pointerout', homeoutFun)
    ...
    update: function () {
        ...
        if ((Math.round(level17lpbar1.x) <= 134)) {
            if (Math.round(level17lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level17lpbar1.setVisible(true);
                level17lpbar2.setVisible(false);
                level17lpbar3.setVisible(false);
                level17lpbar4.setVisible(false);
                emojis.x = Math.round(level17lpbar1.x) + 252
            } else if ((Math.round(level17lpbar1.x) > -77.5) && (Math.round(level17lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level17lpbar1.setVisible(false);
                level17lpbar2.setVisible(true);
                level17lpbar3.setVisible(false);
                level17lpbar4.setVisible(false);
                emojis.x = Math.round(level17lpbar1.x) + 252
            } else if ((Math.round(level17lpbar1.x) > -7) && (Math.round(level17lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level17lpbar1.setVisible(false);
                level17lpbar2.setVisible(false);
                level17lpbar3.setVisible(true);
                level17lpbar4.setVisible(false);
                emojis.x = Math.round(level17lpbar1.x) + 252
            } else if ((Math.round(level17lpbar1.x) > 63.5) && (Math.round(level17lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level17lpbar1.setVisible(false);
                level17lpbar2.setVisible(false);
                level17lpbar3.setVisible(false);
                level17lpbar4.setVisible(true);
                emojis.x = Math.round(level17lpbar1.x) + 252
            }
        } else if ((Math.round(level17lpbar1.x) > 134)) {
            level17lpbar1.x = 134
            level17lpbar2.x = 134
            level17lpbar3.x = 134
            level17lpbar4.x = 134
