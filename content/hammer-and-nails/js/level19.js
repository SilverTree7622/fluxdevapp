...
var randomArrx = [0];
var randomArry = [0];
var level19 = new Phaser.Class({
    Extends: Phaser.Scene,
    initialize: function level19() {
    ...
    create: function () {
        ...
        level19background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level19wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level19blast = this.add.sprite(150, 209, 'level1blast').setOrigin(0, 0)

        level19blast.visible = false
        ...
        for (var i = 37; i >= 1; i--) {
            ...
            game['level19nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level19nail' + i].setFrame(1);
            game['level19nail' + i].visible = false

        }
        game['level19nail' + 1].visible = true
        ...
        levelpop1.add(level19wood)
        levelpop1.add(bomb)
        levelpop1.add(explode)
        for (i = 37; i >= 1; i--) {
            levelpop1.add(game['level19nail' + i])
        }

        levelpop1.add(level19blast)
        ...
        level19blast.anims.load('level1blast')
        level19blast.x = 354
        level19blast.y = 422
        anim = game.scene.scenes[pageNo].anims.create({
            key: 'bomb',
        ...
        function timecheck() {
            ...
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 37 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 37 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        level19lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level19lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level19lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level19lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level19lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level19lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level19lpmask1.createBitmapMask();
        mask.alpha = 0
        
        level19lpbar4.setMask(mask);
        level19lpbar3.setMask(mask);
        level19lpbar2.setMask(mask);
        level19lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)

        level19stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)




        for (i = 37; i >= 1; i--) {
            game['level19nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            if (game['level19nail' + narr1[0]].x >= 75 && game['level19nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level19nail' + narr1[0]].x - 65
                lhammer.y = game['level19nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level19nail' + narr1[0]].x >= 215 && game['level19nail' + narr1[0]].x <= 354) {
                shammer.x = game['level19nail' + narr1[0]].x - 45
                shammer.y = game['level19nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level19nail' + narr1[0]].x >= 355 && game['level19nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level19nail' + narr1[0]].x - 45
                rhammer.y = game['level19nail' + narr1[0]].y - 45
            ...
            if (game['level19nail' + narr1[0]].frame.name == 1) {
                game['level19nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level19nail' + narr1[0]].frame.name == 2) {
                game['level19nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level19nail' + narr1[0]].frame.name == 3) {
                game['level19nail' + narr1[0]].setFrame(harr1[3])
                game['level19nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level19nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 300,
                    duration: 300,
                ...
                if (narr1[0] <= 37) {
                    ...
                    if (nailcount < 37) {
                        game['level19nail' + (nailcount + 1)].visible = true
                    }
                }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level19lpbar1.x = level19lpbar1.x + (282 / 37)
            level19lpbar2.x = level19lpbar2.x + (282 / 37)
            level19lpbar3.x = level19lpbar3.x + (282 / 37)
            level19lpbar4.x = level19lpbar4.x + (282 / 37)
            if (nailcount == 37) {
                nextnail = false
        ...
        function bombFun() {
            ...
            level19blast.visible = true
            bomb.visible = false
            level19blast.x = bomb.x
            level19blast.y = bomb.y
            level19blast.anims.play('level1blast')

            for (i = 37; i >= 1; i--) {
                game['level19nail' + i].disableInteractive()
            }
        ...
        bomb.alpha = 0
        if (nailcount < 37 && nextnail && timearr[1] != 0) {
        ...
        level19home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level19home.setScale(0.85)
        level19home.on('pointerdown', homeFun)
        level19home.on('pointerover', homeoverFun)
        level19home.on('pointerout', homeoutFun)
    ...
    update: function () {
        ...
        if ((Math.round(level19lpbar1.x) <= 134)) {
            if (Math.round(level19lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level19lpbar1.setVisible(true);
                level19lpbar2.setVisible(false);
                level19lpbar3.setVisible(false);
                level19lpbar4.setVisible(false);
                emojis.x = Math.round(level19lpbar1.x) + 252
            } else if ((Math.round(level19lpbar1.x) > -77.5) && (Math.round(level19lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level19lpbar1.setVisible(false);
                level19lpbar2.setVisible(true);
                level19lpbar3.setVisible(false);
                level19lpbar4.setVisible(false);
                emojis.x = Math.round(level19lpbar1.x) + 252
            } else if ((Math.round(level19lpbar1.x) > -7) && (Math.round(level19lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level19lpbar1.setVisible(false);
                level19lpbar2.setVisible(false);
                level19lpbar3.setVisible(true);
                level19lpbar4.setVisible(false);
                emojis.x = Math.round(level19lpbar1.x) + 252
            } else if ((Math.round(level19lpbar1.x) > 63.5) && (Math.round(level19lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level19lpbar1.setVisible(false);
                level19lpbar2.setVisible(false);
                level19lpbar3.setVisible(false);
                level19lpbar4.setVisible(true);
                emojis.x = Math.round(level19lpbar1.x) + 252
            }
        } else if ((Math.round(level19lpbar1.x) > 134)) {
            level19lpbar1.x = 134
            level19lpbar2.x = 134
            level19lpbar3.x = 134
            level19lpbar4.x = 134
