...
var randomArrx = [0];
var randomArry = [0];
var level22 = new Phaser.Class({
    Extends: Phaser.Scene,
    initialize: function level22() {
    ...
    create: function () {
        ...
        level22background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level22wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level22blast = this.add.sprite(150, 209, 'level1blast').setOrigin(0, 0)

        level22blast.visible = false
        ...
        for (var i = 42; i >= 1; i--) {
            ...
            game['level22nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level22nail' + i].setFrame(1);
            game['level22nail' + i].visible = false

        }
        game['level22nail' + 1].visible = true
        ...
        levelpop1.add(level22wood)
        levelpop1.add(bomb)
        levelpop1.add(explode)
        for (i = 42; i >= 1; i--) {
            levelpop1.add(game['level22nail' + i])
        }

        levelpop1.add(level22blast)
        ...
        level22blast.anims.load('level1blast')
        level22blast.x = 354
        level22blast.y = 422
        anim = game.scene.scenes[pageNo].anims.create({
            key: 'bomb',
        ...
        function timecheck() {
            ...
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 42 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 42 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        level22lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level22lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level22lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level22lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level22lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level22lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level22lpmask1.createBitmapMask();
        mask.alpha = 0
        
        level22lpbar4.setMask(mask);
        level22lpbar3.setMask(mask);
        level22lpbar2.setMask(mask);
        level22lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)

        level22stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)




        for (i = 42; i >= 1; i--) {
            game['level22nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            if (game['level22nail' + narr1[0]].x >= 75 && game['level22nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level22nail' + narr1[0]].x - 65
                lhammer.y = game['level22nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level22nail' + narr1[0]].x >= 215 && game['level22nail' + narr1[0]].x <= 354) {
                shammer.x = game['level22nail' + narr1[0]].x - 45
                shammer.y = game['level22nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level22nail' + narr1[0]].x >= 355 && game['level22nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level22nail' + narr1[0]].x - 45
                rhammer.y = game['level22nail' + narr1[0]].y - 45
            ...
            if (game['level22nail' + narr1[0]].frame.name == 1) {
                game['level22nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level22nail' + narr1[0]].frame.name == 2) {
                game['level22nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level22nail' + narr1[0]].frame.name == 3) {
                game['level22nail' + narr1[0]].setFrame(harr1[3])
                game['level22nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level22nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 300,
                    duration: 300,
                ...
                if (narr1[0] <= 42) {
                    ...
                    if (nailcount < 42) {
                        game['level22nail' + (nailcount + 1)].visible = true
                    }
                }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level22lpbar1.x = level22lpbar1.x + (282 / 42)
            level22lpbar2.x = level22lpbar2.x + (282 / 42)
            level22lpbar3.x = level22lpbar3.x + (282 / 42)
            level22lpbar4.x = level22lpbar4.x + (282 / 42)
            if (nailcount == 42) {
                nextnail = false
        ...
        function bombFun() {
            ...
            level22blast.visible = true
            bomb.visible = false
            level22blast.x = bomb.x
            level22blast.y = bomb.y
            level22blast.anims.play('level1blast')

            for (i = 42; i >= 1; i--) {
                game['level22nail' + i].disableInteractive()
            }
        ...
        bomb.alpha = 0
        if (nailcount < 42 && nextnail && timearr[1] != 0) {
       ...
       failedpanel = this.add.image(240, 427, 'failedpanel').setOrigin(0.5, 0.5)
        ...
        level22home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level22home.setScale(0.85)
        level22home.on('pointerdown', homeFun)
        level22home.on('pointerover', homeoverFun)
        level22home.on('pointerout', homeoutFun)
    ...
    update: function () {
        ...
        if ((Math.round(level22lpbar1.x) <= 134)) {
            if (Math.round(level22lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level22lpbar1.setVisible(true);
                level22lpbar2.setVisible(false);
                level22lpbar3.setVisible(false);
                level22lpbar4.setVisible(false);
                emojis.x = Math.round(level22lpbar1.x) + 252
            } else if ((Math.round(level22lpbar1.x) > -77.5) && (Math.round(level22lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level22lpbar1.setVisible(false);
                level22lpbar2.setVisible(true);
                level22lpbar3.setVisible(false);
                level22lpbar4.setVisible(false);
                emojis.x = Math.round(level22lpbar1.x) + 252
            } else if ((Math.round(level22lpbar1.x) > -7) && (Math.round(level22lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level22lpbar1.setVisible(false);
                level22lpbar2.setVisible(false);
                level22lpbar3.setVisible(true);
                level22lpbar4.setVisible(false);
                emojis.x = Math.round(level22lpbar1.x) + 252
            } else if ((Math.round(level22lpbar1.x) > 63.5) && (Math.round(level22lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level22lpbar1.setVisible(false);
                level22lpbar2.setVisible(false);
                level22lpbar3.setVisible(false);
                level22lpbar4.setVisible(true);
                emojis.x = Math.round(level22lpbar1.x) + 252
            }
        } else if ((Math.round(level22lpbar1.x) > 134)) {
            level22lpbar1.x = 134
            level22lpbar2.x = 134
            level22lpbar3.x = 134
            level22lpbar4.x = 134
