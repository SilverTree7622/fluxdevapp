...
var level4 = new Phaser.Class({
    ...
    create: function () {
        level4background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level4wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level4blast = this.add.sprite(150, 209, 'level1blast').setOrigin(0, 0)
        level4blast.visible = false
        for (var i = 8; i >= 1; i--) {
            var x, y;
            do {
            ...
            randomArrx.push(x);
            randomArry.push(y);
            game['level4nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level4nail' + i].setFrame(1);
            game['level4nail' + i].visible = false
        }
        game['level4nail' + 1].visible = true
        ...
        levelpop1.add(level4wood)
        for (i = 8; i >= 1; i--) {
            levelpop1.add(game['level4nail' + i])
        }
        levelpop1.add(level4blast)
        ...
        level4blast.anims.load('level1blast')
        level4blast.x = 354
        level4blast.y = 422
        timecheck()

        function timecheck() {
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 8 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 8 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        function timeup() {
            timer.remove()
            if (nailcount == 8 && !nextnail) {
                finalpanel()
            } else {
                levelfailed()
            }
        }
        level4lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level4lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level4lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level4lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level4lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level4lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level4lpmask1.createBitmapMask();
        mask.alpha = 0
        level4lpbar4.setMask(mask);
        level4lpbar3.setMask(mask);
        level4lpbar2.setMask(mask);
        level4lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)
        level4stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)
        for (i = 8; i >= 1; i--) {
            game['level4nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            shammer.visible = false
            lhammer.visible = false
            if (game['level4nail' + narr1[0]].x >= 75 && game['level4nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level4nail' + narr1[0]].x - 65
                lhammer.y = game['level4nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level4nail' + narr1[0]].x >= 215 && game['level4nail' + narr1[0]].x <= 354) {
                shammer.x = game['level4nail' + narr1[0]].x - 45
                shammer.y = game['level4nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level4nail' + narr1[0]].x >= 355 && game['level4nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level4nail' + narr1[0]].x - 45
                rhammer.y = game['level4nail' + narr1[0]].y - 45
            ...
            if (game['level4nail' + narr1[0]].frame.name == 1) {
                game['level4nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level4nail' + narr1[0]].frame.name == 2) {
                game['level4nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level4nail' + narr1[0]].frame.name == 3) {
                game['level4nail' + narr1[0]].setFrame(harr1[3])
                game['level4nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level4nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 500,
                    duration: 300,
                ...
                if (narr1[0] <= 8) {
                    ...
                    if (nailcount < 8) {
                        game['level4nail' + (nailcount + 1)].visible = true
                    }
                }
            }
        }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level4lpbar1.x = level4lpbar1.x + (282 / 8)
            level4lpbar2.x = level4lpbar2.x + (282 / 8)
            level4lpbar3.x = level4lpbar3.x + (282 / 8)
            level4lpbar4.x = level4lpbar4.x + (282 / 8)
            if (nailcount == 8) {
                nextnail = false
            }
        }
        ...
        level4home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level4home.setScale(0.85)
        level4home.on('pointerdown', homeFun)
        level4home.on('pointerover', homeoverFun)
        level4home.on('pointerout', homeoutFun)
    ...
    update: function () {
        if ((Math.round(level4lpbar1.x) <= 134)) {
            if (Math.round(level4lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level4lpbar1.setVisible(true);
                level4lpbar2.setVisible(false);
                level4lpbar3.setVisible(false);
                level4lpbar4.setVisible(false);
                emojis.x = Math.round(level4lpbar1.x) + 252
            } else if ((Math.round(level4lpbar1.x) > -77.5) && (Math.round(level4lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level4lpbar1.setVisible(false);
                level4lpbar2.setVisible(true);
                level4lpbar3.setVisible(false);
                level4lpbar4.setVisible(false);
                emojis.x = Math.round(level4lpbar1.x) + 252
            } else if ((Math.round(level4lpbar1.x) > -7) && (Math.round(level4lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level4lpbar1.setVisible(false);
                level4lpbar2.setVisible(false);
                level4lpbar3.setVisible(true);
                level4lpbar4.setVisible(false);
                emojis.x = Math.round(level4lpbar1.x) + 252
            } else if ((Math.round(level4lpbar1.x) > 63.5) && (Math.round(level4lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level4lpbar1.setVisible(false);
                level4lpbar2.setVisible(false);
                level4lpbar3.setVisible(false);
                level4lpbar4.setVisible(true);
                emojis.x = Math.round(level4lpbar1.x) + 252
            }
        } else if ((Math.round(level4lpbar1.x) > 134)) {
            level4lpbar1.x = 134
            level4lpbar2.x = 134
            level4lpbar3.x = 134
            level4lpbar4.x = 134
