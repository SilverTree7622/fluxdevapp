...
var randomArrx = [0];
var randomArry = [0];
var level13 = new Phaser.Class({
    Extends: Phaser.Scene,
    initialize: function level13() {
    ...
    create: function () {
        ...
        level13background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level13wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level13blast = this.add.sprite(150, 209, 'level1blast').setOrigin(0, 0)

        level13blast.visible = false
        ...
        for (var i = 25; i >= 1; i--) {
            ...
            game['level13nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level13nail' + i].setFrame(1);
            game['level13nail' + i].visible = false



        }

        game['level13nail' + 1].visible = true
        ...
        levelpop1.add(level13wood)

        for (i = 25; i >= 1; i--) {
            levelpop1.add(game['level13nail' + i])
        }

        levelpop1.add(level13blast)
        ...
        level13blast.anims.load('level1blast')
        level13blast.x = 354
        level13blast.y = 422
        ...
        function timecheck() {
            ...
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 25 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 25 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        level13lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level13lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level13lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level13lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level13lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level13lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level13lpmask1.createBitmapMask();
        mask.alpha = 0
        
        level13lpbar4.setMask(mask);
        level13lpbar3.setMask(mask);
        level13lpbar2.setMask(mask);
        level13lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)

        level13stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)




        for (i = 25; i >= 1; i--) {
            game['level13nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            if (game['level13nail' + narr1[0]].x >= 75 && game['level13nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level13nail' + narr1[0]].x - 65
                lhammer.y = game['level13nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level13nail' + narr1[0]].x >= 215 && game['level13nail' + narr1[0]].x <= 354) {
                shammer.x = game['level13nail' + narr1[0]].x - 45
                shammer.y = game['level13nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level13nail' + narr1[0]].x >= 355 && game['level13nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level13nail' + narr1[0]].x - 45
                rhammer.y = game['level13nail' + narr1[0]].y - 45
            ...
            if (game['level13nail' + narr1[0]].frame.name == 1) {
                game['level13nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level13nail' + narr1[0]].frame.name == 2) {
                game['level13nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level13nail' + narr1[0]].frame.name == 3) {
                game['level13nail' + narr1[0]].setFrame(harr1[3])
                game['level13nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level13nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 500,
                    duration: 300,
                ...
                if (narr1[0] <= 25) {
                    ...
                    if (nailcount < 25) {
                        game['level13nail' + (nailcount + 1)].visible = true
                    }
                }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level13lpbar1.x = level13lpbar1.x + (282 / 25)
            level13lpbar2.x = level13lpbar2.x + (282 / 25)
            level13lpbar3.x = level13lpbar3.x + (282 / 25)
            level13lpbar4.x = level13lpbar4.x + (282 / 25)
            if (nailcount == 25) {
                nextnail = false
            }
        ...
        level13home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level13home.setScale(0.85)
        level13home.on('pointerdown', homeFun)
        level13home.on('pointerover', homeoverFun)
        level13home.on('pointerout', homeoutFun)
    ...
    update: function () {
        ...
        if ((Math.round(level13lpbar1.x) <= 134)) {
            if (Math.round(level13lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level13lpbar1.setVisible(true);
                level13lpbar2.setVisible(false);
                level13lpbar3.setVisible(false);
                level13lpbar4.setVisible(false);
                emojis.x = Math.round(level13lpbar1.x) + 252
            } else if ((Math.round(level13lpbar1.x) > -77.5) && (Math.round(level13lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level13lpbar1.setVisible(false);
                level13lpbar2.setVisible(true);
                level13lpbar3.setVisible(false);
                level13lpbar4.setVisible(false);
                emojis.x = Math.round(level13lpbar1.x) + 252
            } else if ((Math.round(level13lpbar1.x) > -7) && (Math.round(level13lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level13lpbar1.setVisible(false);
                level13lpbar2.setVisible(false);
                level13lpbar3.setVisible(true);
                level13lpbar4.setVisible(false);
                emojis.x = Math.round(level13lpbar1.x) + 252
            } else if ((Math.round(level13lpbar1.x) > 63.5) && (Math.round(level13lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level13lpbar1.setVisible(false);
                level13lpbar2.setVisible(false);
                level13lpbar3.setVisible(false);
                level13lpbar4.setVisible(true);
                emojis.x = Math.round(level13lpbar1.x) + 252
            }
        } else if ((Math.round(level13lpbar1.x) > 134)) {
            level13lpbar1.x = 134
            level13lpbar2.x = 134
            level13lpbar3.x = 134
            level13lpbar4.x = 134
