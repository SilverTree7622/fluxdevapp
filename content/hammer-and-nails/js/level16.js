...
var randomArrx = [0];
var randomArry = [0];
var level16 = new Phaser.Class({
    Extends: Phaser.Scene,
    initialize: function level16() {
    ...
    create: function () {
        ...
        level16background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level16wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level16blast = this.add.sprite(300, 200, 'level1blast').setOrigin(0, 0)


        level16blast.visible = false
        ...
        for (var i = 31; i >= 1; i--) {
            ...
            game['level16nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level16nail' + i].setFrame(1);
            game['level16nail' + i].visible = false

        }
        game['level16nail' + 1].visible = true
        ...
        for (i = 31; i >= 1; i--) {
            levelpop1.add(game['level16nail' + i])
        }


        levelpop1.add(level16blast)
        ...
        level16blast.anims.load('level1blast')
        level16blast.x = 354
        level16blast.y = 422
        anim = game.scene.scenes[pageNo].anims.create({
            key: 'bomb',
        ...
        function timecheck() {
            ...
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 31 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 31 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        level16lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level16lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level16lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level16lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level16lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level16lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level16lpmask1.createBitmapMask();
        mask.alpha = 0
        
        level16lpbar4.setMask(mask);
        level16lpbar3.setMask(mask);
        level16lpbar2.setMask(mask);
        level16lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)

        level16stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)




        for (i = 31; i >= 1; i--) {
            game['level16nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            if (game['level16nail' + narr1[0]].x >= 75 && game['level16nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level16nail' + narr1[0]].x - 65
                lhammer.y = game['level16nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level16nail' + narr1[0]].x >= 215 && game['level16nail' + narr1[0]].x <= 354) {
                shammer.x = game['level16nail' + narr1[0]].x - 45
                shammer.y = game['level16nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level16nail' + narr1[0]].x >= 355 && game['level16nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level16nail' + narr1[0]].x - 45
                rhammer.y = game['level16nail' + narr1[0]].y - 45
            ...
            if (game['level16nail' + narr1[0]].frame.name == 1) {
                game['level16nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level16nail' + narr1[0]].frame.name == 2) {
                game['level16nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level16nail' + narr1[0]].frame.name == 3) {
                game['level16nail' + narr1[0]].setFrame(harr1[3])
                game['level16nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level16nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 300,
                    duration: 300,
                ...
                if (narr1[0] <= 31) {
                    ...
                    if (nailcount < 31) {
                        game['level16nail' + (nailcount + 1)].visible = true
                    }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level16lpbar1.x = level16lpbar1.x + (282 / 31)
            level16lpbar2.x = level16lpbar2.x + (282 / 31)
            level16lpbar3.x = level16lpbar3.x + (282 / 31)
            level16lpbar4.x = level16lpbar4.x + (282 / 31)
            if (nailcount == 31) {
                nextnail = false
        ...
        function bombFun() {
            ...
            level16blast.x = bomb.x
            level16blast.y = bomb.y
            level16blast.anims.play('level1blast')

            for (i = 31; i >= 1; i--) {
                game['level16nail' + i].disableInteractive()
            }
        ...
        bomb.alpha = 0
        if (nailcount < 31 && nextnail && timearr[1] != 0) {
     ...
     failedpanel = this.add.image(240, 427, 'failedpanel').setOrigin(0.5, 0.5)
        ...
        level16home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level16home.setScale(0.85)
        level16home.on('pointerdown', homeFun)
        level16home.on('pointerover', homeoverFun)
        level16home.on('pointerout', homeoutFun)
    ...
    update: function () {
        ...
        if ((Math.round(level16lpbar1.x) <= 134)) {
            if (Math.round(level16lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level16lpbar1.setVisible(true);
                level16lpbar2.setVisible(false);
                level16lpbar3.setVisible(false);
                level16lpbar4.setVisible(false);
                emojis.x = Math.round(level16lpbar1.x) + 252
            } else if ((Math.round(level16lpbar1.x) > -77.5) && (Math.round(level16lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level16lpbar1.setVisible(false);
                level16lpbar2.setVisible(true);
                level16lpbar3.setVisible(false);
                level16lpbar4.setVisible(false);
                emojis.x = Math.round(level16lpbar1.x) + 252
            } else if ((Math.round(level16lpbar1.x) > -7) && (Math.round(level16lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level16lpbar1.setVisible(false);
                level16lpbar2.setVisible(false);
                level16lpbar3.setVisible(true);
                level16lpbar4.setVisible(false);
                emojis.x = Math.round(level16lpbar1.x) + 252
            } else if ((Math.round(level16lpbar1.x) > 63.5) && (Math.round(level16lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level16lpbar1.setVisible(false);
                level16lpbar2.setVisible(false);
                level16lpbar3.setVisible(false);
                level16lpbar4.setVisible(true);
                emojis.x = Math.round(level16lpbar1.x) + 252
            }
        } else if ((Math.round(level16lpbar1.x) > 134)) {
            level16lpbar1.x = 134
            level16lpbar2.x = 134
            level16lpbar3.x = 134
            level16lpbar4.x = 134
