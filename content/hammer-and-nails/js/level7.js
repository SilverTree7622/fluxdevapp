...
var level7 = new Phaser.Class({
    ...
    create: function () {
        ...
        level7background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level7wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level7blast = this.add.sprite(150, 209, 'level1blast').setOrigin(0, 0)

        level7blast.visible = false
        ...
        for (var i = 14; i >= 1; i--) {
            ...
            game['level7nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level7nail' + i].setFrame(1);
            game['level7nail' + i].visible = false



        }
        game['level7nail' + 1].visible = true
        ...
        levelpop1.add(level7wood)

        for (i = 14; i >= 1; i--) {
            levelpop1.add(game['level7nail' + i])
        }

        levelpop1.add(level7blast)
        ...
        level7blast.anims.load('level1blast')
        level7blast.x = 354
        level7blast.y = 422
        ...
        function timecheck() {
            ...
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 14 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 14 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        level7lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level7lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level7lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level7lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level7lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level7lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level7lpmask1.createBitmapMask();
        mask.alpha = 0
        
        level7lpbar4.setMask(mask);
        level7lpbar3.setMask(mask);
        level7lpbar2.setMask(mask);
        level7lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)

        level7stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)




        for (i = 14; i >= 1; i--) {
            game['level7nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            if (game['level7nail' + narr1[0]].x >= 75 && game['level7nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level7nail' + narr1[0]].x - 65
                lhammer.y = game['level7nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level7nail' + narr1[0]].x >= 215 && game['level7nail' + narr1[0]].x <= 354) {
                shammer.x = game['level7nail' + narr1[0]].x - 45
                shammer.y = game['level7nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level7nail' + narr1[0]].x >= 355 && game['level7nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level7nail' + narr1[0]].x - 45
                rhammer.y = game['level7nail' + narr1[0]].y - 45
            ...
            if (game['level7nail' + narr1[0]].frame.name == 1) {
                game['level7nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level7nail' + narr1[0]].frame.name == 2) {
                game['level7nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level7nail' + narr1[0]].frame.name == 3) {
                game['level7nail' + narr1[0]].setFrame(harr1[3])
                game['level7nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level7nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 500,
                    duration: 300,
                ...
                if (narr1[0] <= 14) {
                    ...
                    if (nailcount < 14) {
                        game['level7nail' + (nailcount + 1)].visible = true
                    }
                }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level7lpbar1.x = level7lpbar1.x + (282 / 14)
            level7lpbar2.x = level7lpbar2.x + (282 / 14)
            level7lpbar3.x = level7lpbar3.x + (282 / 14)
            level7lpbar4.x = level7lpbar4.x + (282 / 14)
            if (nailcount == 14) {
                nextnail = false
            }
        ...
        level7home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level7home.setScale(0.85)
        level7home.on('pointerdown', homeFun)
        level7home.on('pointerover', homeoverFun)
        level7home.on('pointerout', homeoutFun)
    ...
    update: function () {
        ...
        if ((Math.round(level7lpbar1.x) <= 134)) {
            if (Math.round(level7lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level7lpbar1.setVisible(true);
                level7lpbar2.setVisible(false);
                level7lpbar3.setVisible(false);
                level7lpbar4.setVisible(false);
                emojis.x = Math.round(level7lpbar1.x) + 252
            } else if ((Math.round(level7lpbar1.x) > -77.5) && (Math.round(level7lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level7lpbar1.setVisible(false);
                level7lpbar2.setVisible(true);
                level7lpbar3.setVisible(false);
                level7lpbar4.setVisible(false);
                emojis.x = Math.round(level7lpbar1.x) + 252
            } else if ((Math.round(level7lpbar1.x) > -7) && (Math.round(level7lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level7lpbar1.setVisible(false);
                level7lpbar2.setVisible(false);
                level7lpbar3.setVisible(true);
                level7lpbar4.setVisible(false);
                emojis.x = Math.round(level7lpbar1.x) + 252
            } else if ((Math.round(level7lpbar1.x) > 63.5) && (Math.round(level7lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level7lpbar1.setVisible(false);
                level7lpbar2.setVisible(false);
                level7lpbar3.setVisible(false);
                level7lpbar4.setVisible(true);
                emojis.x = Math.round(level7lpbar1.x) + 252
            }
        } else if ((Math.round(level7lpbar1.x) > 134)) {
            level7lpbar1.x = 134
            level7lpbar2.x = 134
            level7lpbar3.x = 134
            level7lpbar4.x = 134
