...
var level24 = new Phaser.Class({
    ...
    create: function () {
        ...
        level24background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level24wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level24blast = this.add.sprite(150, 209, 'level1blast').setOrigin(0, 0)

        level24blast.visible = false
        ...
        for (var i = 44; i >= 1; i--) {
            ...
            game['level24nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level24nail' + i].setFrame(1);
            game['level24nail' + i].visible = false

        }
        game['level24nail' + 1].visible = true
        ...
        levelpop1.add(level24wood)
        levelpop1.add(bomb)
        levelpop1.add(explode)
        for (i = 44; i >= 1; i--) {
            levelpop1.add(game['level24nail' + i])
        }

        levelpop1.add(level24blast)
        ...
        level24blast.anims.load('level1blast')
        level24blast.x = 354
        level24blast.y = 422
        anim = game.scene.scenes[pageNo].anims.create({
            key: 'bomb',
        ...
        function timecheck() {
            ...
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 44 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 44 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        level24lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level24lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level24lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level24lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level24lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level24lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level24lpmask1.createBitmapMask();
        mask.alpha = 0
        
        level24lpbar4.setMask(mask);
        level24lpbar3.setMask(mask);
        level24lpbar2.setMask(mask);
        level24lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)

        level24stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)




        for (i = 44; i >= 1; i--) {
            game['level24nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            if (game['level24nail' + narr1[0]].x >= 75 && game['level24nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level24nail' + narr1[0]].x - 65
                lhammer.y = game['level24nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level24nail' + narr1[0]].x >= 215 && game['level24nail' + narr1[0]].x <= 354) {
                shammer.x = game['level24nail' + narr1[0]].x - 45
                shammer.y = game['level24nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level24nail' + narr1[0]].x >= 355 && game['level24nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level24nail' + narr1[0]].x - 45
                rhammer.y = game['level24nail' + narr1[0]].y - 45
            ...
            if (game['level24nail' + narr1[0]].frame.name == 1) {
                game['level24nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level24nail' + narr1[0]].frame.name == 2) {
                game['level24nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level24nail' + narr1[0]].frame.name == 3) {
                game['level24nail' + narr1[0]].setFrame(harr1[3])
                game['level24nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level24nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 300,
                    duration: 300,
                ...
                if (narr1[0] <= 44) {
                    ...
                    if (nailcount < 44) {
                        game['level24nail' + (nailcount + 1)].visible = true
                    }
                }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level24lpbar1.x = level24lpbar1.x + (282 / 44)
            level24lpbar2.x = level24lpbar2.x + (282 / 44)
            level24lpbar3.x = level24lpbar3.x + (282 / 44)
            level24lpbar4.x = level24lpbar4.x + (282 / 44)
            if (nailcount == 44) {
                nextnail = false
        ...
        function bombFun() {
            ...
            level24blast.visible = true
            bomb.visible = false
            level24blast.x = bomb.x
            level24blast.y = bomb.y
            level24blast.anims.play('level1blast')

            for (i = 44; i >= 1; i--) {
                game['level24nail' + i].disableInteractive()
            }
        ...
        bomb.alpha = 0
        if (nailcount < 44 && nextnail && timearr[1] != 0) {
      ...
      failedpanel = this.add.image(240, 427, 'failedpanel').setOrigin(0.5, 0.5)
        ...
        level24home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level24home.setScale(0.85)
        level24home.on('pointerdown', homeFun)
        level24home.on('pointerover', homeoverFun)
        level24home.on('pointerout', homeoutFun)
    ...
    update: function () {
        ...
        if ((Math.round(level24lpbar1.x) <= 134)) {
            if (Math.round(level24lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level24lpbar1.setVisible(true);
                level24lpbar2.setVisible(false);
                level24lpbar3.setVisible(false);
                level24lpbar4.setVisible(false);
                emojis.x = Math.round(level24lpbar1.x) + 252
            } else if ((Math.round(level24lpbar1.x) > -77.5) && (Math.round(level24lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level24lpbar1.setVisible(false);
                level24lpbar2.setVisible(true);
                level24lpbar3.setVisible(false);
                level24lpbar4.setVisible(false);
                emojis.x = Math.round(level24lpbar1.x) + 252
            } else if ((Math.round(level24lpbar1.x) > -7) && (Math.round(level24lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level24lpbar1.setVisible(false);
                level24lpbar2.setVisible(false);
                level24lpbar3.setVisible(true);
                level24lpbar4.setVisible(false);
                emojis.x = Math.round(level24lpbar1.x) + 252
            } else if ((Math.round(level24lpbar1.x) > 63.5) && (Math.round(level24lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level24lpbar1.setVisible(false);
                level24lpbar2.setVisible(false);
                level24lpbar3.setVisible(false);
                level24lpbar4.setVisible(true);
                emojis.x = Math.round(level24lpbar1.x) + 252
            }
        } else if ((Math.round(level24lpbar1.x) > 134)) {
            level24lpbar1.x = 134
            level24lpbar2.x = 134
            level24lpbar3.x = 134
            level24lpbar4.x = 134
