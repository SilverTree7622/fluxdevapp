...
var level9 = new Phaser.Class({
    ...
    create: function () {
        ...
        level9background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level9wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level9blast = this.add.sprite(150, 209, 'level1blast').setOrigin(0, 0)

        level9blast.visible = false
        ...
        for (var i = 18; i >= 1; i--) {
            ...
            game['level9nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level9nail' + i].setFrame(1);
            game['level9nail' + i].visible = false



        }
        game['level9nail' + 1].visible = true
        ...
        levelpop1.add(level9wood)

        for (i = 18; i >= 1; i--) {
            levelpop1.add(game['level9nail' + i])
        }

        levelpop1.add(level9blast)
        ...
        level9blast.anims.load('level1blast')
        level9blast.x = 354
        level9blast.y = 422
        ...
        function timecheck() {
            ...
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 18 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 18 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        level9lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level9lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level9lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level9lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level9lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level9lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level9lpmask1.createBitmapMask();
        mask.alpha = 0
        
        level9lpbar4.setMask(mask);
        level9lpbar3.setMask(mask);
        level9lpbar2.setMask(mask);
        level9lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)

        level9stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)




        for (i = 18; i >= 1; i--) {
            game['level9nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            if (game['level9nail' + narr1[0]].x >= 75 && game['level9nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level9nail' + narr1[0]].x - 65
                lhammer.y = game['level9nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level9nail' + narr1[0]].x >= 215 && game['level9nail' + narr1[0]].x <= 354) {
                shammer.x = game['level9nail' + narr1[0]].x - 45
                shammer.y = game['level9nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level9nail' + narr1[0]].x >= 355 && game['level9nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level9nail' + narr1[0]].x - 45
                rhammer.y = game['level9nail' + narr1[0]].y - 45
            ...
            if (game['level9nail' + narr1[0]].frame.name == 1) {
                game['level9nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level9nail' + narr1[0]].frame.name == 2) {
                game['level9nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level9nail' + narr1[0]].frame.name == 3) {
                game['level9nail' + narr1[0]].setFrame(harr1[3])
                game['level9nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level9nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 500,
                    duration: 300,
                ...
                if (narr1[0] <= 18) {
                    ...
                    if (nailcount < 18) {
                        game['level9nail' + (nailcount + 1)].visible = true
                    }
                }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level9lpbar1.x = level9lpbar1.x + (282 / 18)
            level9lpbar2.x = level9lpbar2.x + (282 / 18)
            level9lpbar3.x = level9lpbar3.x + (282 / 18)
            level9lpbar4.x = level9lpbar4.x + (282 / 18)
            if (nailcount == 18) {
                nextnail = false
            }
      ...
      failedpanel = this.add.image(240, 427, 'failedpanel').setOrigin(0.5, 0.5)
        ...
        level9home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level9home.setScale(0.85)
        level9home.on('pointerdown', homeFun)
        level9home.on('pointerover', homeoverFun)
        level9home.on('pointerout', homeoutFun)
    ...
    update: function () {
        ...
        if ((Math.round(level9lpbar1.x) <= 134)) {
            if (Math.round(level9lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level9lpbar1.setVisible(true);
                level9lpbar2.setVisible(false);
                level9lpbar3.setVisible(false);
                level9lpbar4.setVisible(false);
                emojis.x = Math.round(level9lpbar1.x) + 252
            } else if ((Math.round(level9lpbar1.x) > -77.5) && (Math.round(level9lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level9lpbar1.setVisible(false);
                level9lpbar2.setVisible(true);
                level9lpbar3.setVisible(false);
                level9lpbar4.setVisible(false);
                emojis.x = Math.round(level9lpbar1.x) + 252
            } else if ((Math.round(level9lpbar1.x) > -7) && (Math.round(level9lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level9lpbar1.setVisible(false);
                level9lpbar2.setVisible(false);
                level9lpbar3.setVisible(true);
                level9lpbar4.setVisible(false);
                emojis.x = Math.round(level9lpbar1.x) + 252
            } else if ((Math.round(level9lpbar1.x) > 63.5) && (Math.round(level9lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level9lpbar1.setVisible(false);
                level9lpbar2.setVisible(false);
                level9lpbar3.setVisible(false);
                level9lpbar4.setVisible(true);
                emojis.x = Math.round(level9lpbar1.x) + 252
            }
        } else if ((Math.round(level9lpbar1.x) > 134)) {
            level9lpbar1.x = 134
            level9lpbar2.x = 134
            level9lpbar3.x = 134
            level9lpbar4.x = 134
