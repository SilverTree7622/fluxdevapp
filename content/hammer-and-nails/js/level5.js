...
var level5 = new Phaser.Class({
    ...
    create: function () {
        ...
        level5background = this.add.image(0, 0, 'level1background').setOrigin(0, 0).setInteractive()
        level5wood = this.add.image(64, 37, 'level1wood').setOrigin(0, 0)
        level5blast = this.add.sprite(150, 209, 'level1blast').setOrigin(0, 0)

        level5blast.visible = false
        ...
        for (var i = 10; i >= 1; i--) {
            ...
            game['level5nail' + i] = this.add.sprite(x + 20, y, 'level1nail' + i).setOrigin(0.5, 0.5).setInteractive();
            game['level5nail' + i].setFrame(1);
            game['level5nail' + i].visible = false

        }

        game['level5nail' + 1].visible = true
        ...
        levelpop1.add(level5wood)

        for (i = 10; i >= 1; i--) {
            levelpop1.add(game['level5nail' + i])
        }

        levelpop1.add(level5blast)
        ...
        level5blast.anims.load('level1blast')
        level5blast.x = 354
        level5blast.y = 422
        ...
        function timecheck() {
            ...
            if (timearr[0] > 0 && timearr[1] >= 0 && nailcount <= 10 && nextnail) {
            ...
            } else if (timearr[0] == 0 && timearr[1] > 0 && nailcount <= 10 && nextnail) {
                timearr[1] = timearr[1] - 1
                if (timearr[1] > 9) {
                    sec.setText(timearr[1])
                } else {
        ...
        level5lpbg = this.add.image(135, 93, 'level1lpbg').setOrigin(0, 0)
        level5lpbar4 = this.add.image(-148, 93, 'level1lpmask4').setOrigin(0, 0)
        level5lpbar3 = this.add.image(-148, 93, 'level1lpmask3').setOrigin(0, 0)
        level5lpbar2 = this.add.image(-148, 93, 'level1lpmask2').setOrigin(0, 0)
        level5lpbar1 = this.add.image(-148, 93, 'level1lpmask1').setOrigin(0, 0)
        level5lpmask1 = this.add.image(135, 93, 'level1lpmask1').setOrigin(0, 0).setVisible(false);
        mask = level5lpmask1.createBitmapMask();
        mask.alpha = 0
        
        level5lpbar4.setMask(mask);
        level5lpbar3.setMask(mask);
        level5lpbar2.setMask(mask);
        level5lpbar1.setMask(mask);
        emojis = this.add.sprite(122, 85, 'emoji').setOrigin(0, 0).setScale(0.7)

        level5stresstxt = this.add.image(180, 49, 'level1stresstxt').setOrigin(0, 0)




        for (i = 10; i >= 1; i--) {
            game['level5nail' + i].on('pointerdown', hammerFun)
        }
        ...
        function hammerFun() {
            ...
            if (game['level5nail' + narr1[0]].x >= 75 && game['level5nail' + narr1[0]].x <= 215) {
                lhammer.x = game['level5nail' + narr1[0]].x - 65
                lhammer.y = game['level5nail' + narr1[0]].y - 45
                lhammer.anims.play('lhammer')
                lhammer.visible = true
            } else if (game['level5nail' + narr1[0]].x >= 215 && game['level5nail' + narr1[0]].x <= 354) {
                shammer.x = game['level5nail' + narr1[0]].x - 45
                shammer.y = game['level5nail' + narr1[0]].y - 45
                shammer.anims.play('shammer')
                shammer.visible = true
            } else if (game['level5nail' + narr1[0]].x >= 355 && game['level5nail' + narr1[0]].x <= 495) {
                rhammer.x = game['level5nail' + narr1[0]].x - 45
                rhammer.y = game['level5nail' + narr1[0]].y - 45
            ...
            if (game['level5nail' + narr1[0]].frame.name == 1) {
                game['level5nail' + narr1[0]].setFrame(harr1[1])
                setTimeout(hiddenHammer, 200)
            } else if (game['level5nail' + narr1[0]].frame.name == 2) {
                game['level5nail' + narr1[0]].setFrame(harr1[2])
                setTimeout(hiddenHammer, 200)
            } else if (game['level5nail' + narr1[0]].frame.name == 3) {
                game['level5nail' + narr1[0]].setFrame(harr1[3])
                game['level5nail' + narr1[0]].disableInteractive()
                game.scene.scenes[pageNo].tweens.add({
                    targets: game['level5nail' + narr1[0]],
                    alpha: 0,
                    ease: 'Back',
                    delay: 500,
                    duration: 300,
                ...
                if (narr1[0] <= 10) {
                    ...
                    if (nailcount < 10) {
                        game['level5nail' + (nailcount + 1)].visible = true
                    }
                }
        ...
        function newnail() {
            ...
            shammer.visible = false
            lhammer.visible = false
            level5lpbar1.x = level5lpbar1.x + (282 / 10)
            level5lpbar2.x = level5lpbar2.x + (282 / 10)
            level5lpbar3.x = level5lpbar3.x + (282 / 10)
            level5lpbar4.x = level5lpbar4.x + (282 / 10)
            if (nailcount == 10) {
                nextnail = false
            }
       ...
       level5home = this.add.sprite(450, 37, 'level1home').setOrigin(0.5, 0.5).setInteractive()
        level5home.setScale(0.85)
        level5home.on('pointerdown', homeFun)
        level5home.on('pointerover', homeoverFun)
        level5home.on('pointerout', homeoutFun)
    ...
    update: function () {
        ...
        if ((Math.round(level5lpbar1.x) <= 134)) {
            if (Math.round(level5lpbar1.x) <= -77.5) {
                emojis.setFrame(0)
                level5lpbar1.setVisible(true);
                level5lpbar2.setVisible(false);
                level5lpbar3.setVisible(false);
                level5lpbar4.setVisible(false);
                emojis.x = Math.round(level5lpbar1.x) + 252
            } else if ((Math.round(level5lpbar1.x) > -77.5) && (Math.round(level5lpbar1.x) <= -7)) {
                emojis.setFrame(1)
                level5lpbar1.setVisible(false);
                level5lpbar2.setVisible(true);
                level5lpbar3.setVisible(false);
                level5lpbar4.setVisible(false);
                emojis.x = Math.round(level5lpbar1.x) + 252
            } else if ((Math.round(level5lpbar1.x) > -7) && (Math.round(level5lpbar1.x) <= 63.5)) {
                emojis.setFrame(2)
                level5lpbar1.setVisible(false);
                level5lpbar2.setVisible(false);
                level5lpbar3.setVisible(true);
                level5lpbar4.setVisible(false);
                emojis.x = Math.round(level5lpbar1.x) + 252
            } else if ((Math.round(level5lpbar1.x) > 63.5) && (Math.round(level5lpbar1.x) <= 134)) {
                emojis.setFrame(3)
                level5lpbar1.setVisible(false);
                level5lpbar2.setVisible(false);
                level5lpbar3.setVisible(false);
                level5lpbar4.setVisible(true);
                emojis.x = Math.round(level5lpbar1.x) + 252
            }
        } else if ((Math.round(level5lpbar1.x) > 134)) {
            level5lpbar1.x = 134
            level5lpbar2.x = 134
            level5lpbar3.x = 134
            level5lpbar4.x = 134
